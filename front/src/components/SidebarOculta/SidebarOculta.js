...
export const SidebarOculta = () => {
    return (
        <>
            <nav class="navbar navbar-dark bg-dark fixed-top">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#"><img src={OnpagLogo} style={{ "height": "40px" }} alt="Onpag Logo"></img></a>
...
{/*
                            ...
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="/home"><img src={DashboardIcon} style={{"margin-right":"15px"}} alt="icone-home"/>Home</a>
                                </li>
                                <li class="nav-item">
